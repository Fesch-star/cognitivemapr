...
be compiled into an edge and nodelists. For an instruction on the
formatting requirements, see the 'Tutorial_edge_nodelist'. This tutorial
also provides an explanation on how to use the three functions in the
package that may help you reformat your data.

For more information regarding the analytical functions in the package,
please refer to the cognitivemapr_Tutorial.
