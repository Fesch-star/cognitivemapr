...
In addition, the sum of saliency divided by two tells us of how many relations the CM
...
# Replace 'your_edgelist' and 'your_nodelist' with the actual data you want to pass to the function
  result_list[[i]] <- cognitivemapr::evaluation_step(rutte_p2_edgelist, rutte_p2_nodelist)
...
#result_list[[4]][[2]][,"val_run1.x.x"]
#result_list[[5]][[2]][,"val_run1.y.y"]
...
#TEST RESULT FEMKE: Unfortunately, after the first iteration, the numbers keep on being the same. Like in the case of the Mystery document, the calculations are not iterated on the outcome of the previous run. Back to the drawing board :(
```
