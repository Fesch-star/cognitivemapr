...
However in order to reap the full benefits of CM analysis and grasp the relations between Rutte's ideas as well as reveal the argumentation and narrative underlying his belief system, the CM is best analysed visually in its graphical form. 

```{r}
cm_rutte <- cognitivemapr::draw_cm(rutte_p2_edgelist, rutte_p2_nodelist)
```
