...
nodelist$paradigms <- ifelse(nodelist$node_name %in% c("a", "b"), "ordoliberal", nodelist$paradigms)
nodelist$instruments <- ifelse(nodelist$node_name == "a", "economic stimulation", nodelist$instruments)

# change the value of concept a from positive to negative
nodelist$value <- ifelse(nodelist$node_name == "c", -1, nodelist$value)
