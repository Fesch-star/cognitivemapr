...
url_rutte_edges <- "https://raw.githubusercontent.com/Fesch-star/cognitivemapr/main/docs/manuscript/rutte_p2-edgelist.csv"
rutte_p2_edgelist<- read_csv(url_rutte_edges)

url_rutte_nodes <- "https://raw.githubusercontent.com/Fesch-star/cognitivemapr/main/docs/manuscript/rutte_p2-nodelist.csv"
rutte_p2_nodelist <- read_csv(url_rutte_nodes)
...
edgelist$val_xt1[is.na(edgelist$val_xt1)] <- 0 #transform nan values in 0
...
while (index < max_runs){
  Evaluation_step (rutte_p2_edgelist, rutte_p2_node_calc)
}
```
