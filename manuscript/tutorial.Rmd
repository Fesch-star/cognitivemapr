...
rutte_p2_node_measures <- cognitivemapr::calc_degrees_goW(rutte_p2_edgelist, rutte_p2_nodelist)
...
```{r}
max_runs <- cognitivemapr::set_max_runs(rutte_p2_edgelist, rutte_p2_nodelist)
```
